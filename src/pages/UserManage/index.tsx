...
async function getUser(options?: { [key: string]: any }) {
...
const UserList: React.FC = () => {
  ...
  const [dataSource, setDataSource] = useState<API.UserList[]>([]);
          ...
          onClick={async () => {
            try {
              ...
              if (res.success === true) {
                ...
                const tableDataSource = formRef.current?.getFieldValue('table') as User[];
